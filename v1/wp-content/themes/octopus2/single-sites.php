      ...
      <div class="panel with-nav-tabs panel-default">
        <div class="panel-heading">
          <ul class="nav nav-tabs" role="tablist" id="myTab">
            ...
            <li><a href="#tab2users" role="tab" data-toggle="tab"><i class="fa fa-users" style="color:#FC5830"></i> Users</a></li>
            <li><a href="#tab3assets" drole="tab" data-toggle="tab"><i class="fa fa-desktop" style="color:#2C98F0"></i> Assets</a></li>
          </ul>
        </div>
              ...
              <div class="table-responsive">
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row"><strong>City / Town:</strong></th>
                      <td>
                    ...
                    <tr>
                      <th scope="row"><strong>County:</strong></th>
                      <td>
...
<div class="post_count"><?php echo $the_query->found_posts; ?> Users</div>
                <div class="table-responsive">
                  <table class="table">
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a data-title="DDI Tel" href="#" id="text-field" name="<?php echo $meta_key;?>" data-type="text" data-inputclass="form-control" data-pk="<?php echo $id;?>" class="text-field">
                          <?php echo get_post_meta( $id, $meta_key, true ); $id = $meta_key = '';?>
                        </a>
                      </td>
                      <td>
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tr>
                      ...
                      <td>
                        <?php $meta_key = 'asset_status'; $id = get_the_id(); ?><a data-title="Asset Status" href="#" id="asset-status" name="<?php echo $meta_key;?>" data-type="select" data-value="" data-source="[{value:'Active',text:'Active'},{value:'Not Active',text:'Not Active'},{value:'',text:'Empty'}]" data-pk="<?php echo $id;?>"   class="text-field"><?php echo get_post_meta( $id, $meta_key, true ); $id = $meta_key = '';?></a></td>	
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                       <?php $meta_key = 'site_status'; $id = get_the_id(); ?><a data-title="Site Status" href="#" id="vpn" name="<?php echo $meta_key;?>" data-type="select" data-value="" data-source="[{value:'Active',text:'Active'},{value:'Not Active',text:'Not Active'},{value:'',text:'Empty'}]" data-pk="<?php echo $id;?>"   class="text-field"><?php echo get_post_meta( $id, $meta_key, true ); $id = $meta_key = '';?></a></td>	
                    </tr>
