...
<div class="panel with-nav-tabs panel-default">
  <ul class="nav nav-tabs">
    ...
    <li><a href="#guru" role="tab" data-toggle="tab">Guru</a></li>
    <li><a href="#logins" role="tab" data-toggle="tab">Logins</a></li>
  ...
  <div class="tab-content">
    ...
    <div id="general" class="tab-pane fade active in">
      <ul class="nav nav-tabs" role="tablist" id="myTab" style="background-color:#232C3E;margin-top:-20px;">
        ...
        <li><a href="#purchasing_2" role="tab" data-toggle="tab">Purchasing & Warranty Information</a></li>
      </ul>
    ...
    <div id="guru" class="tab-pane fade">
      <ul class="nav nav-tabs" style="background-color:#3873b9;margin-top:-20px;">
        <li class="active"><a href="#guru_maintenance" role="tab" data-toggle="tab">Maintenance Windows</a></li>
        <li><a href="#guru_security" role="tab" data-toggle="tab">Security Manager</a></li>
        <li><a href="#guru_patch" role="tab" data-toggle="tab">Patch Management</a></li>
        <li><a href="#guru_backup" role="tab" data-toggle="tab">Backup Management</a></li>
      </ul>
      <!--Guru tab content-->
      <div class="tab-content">
            ...
            <table class="table table-striped">
              <tbody>
                <tr>
                  ...
                  <th scope="row"><strong>AV Profile - Workstation:</strong></th>
                    <td>
                      <?php $meta_key = 'AV_Profile_Desktops'; $id = get_the_id();?>
                      <a data-title="AV Profile - Workstation" href="#" id="text-field" name="<?php echo $meta_key;?>" data-type="text" data-inputclass="form-control" data-pk="<?php echo $id;?>" class="text-field">
                        <?php echo get_post_meta( $id, $meta_key, true ); $id = $meta_key = '';?>
                      </a>
                    </td>
                </tr>
            ...
            <table class="table table-striped">
              <tbody>
                <tr>
                  ...
                  <th scope="row"><strong>Patch Workstations:</strong></th>
                    <td>
                      <?php $meta_key = 'patch_profile_desktops'; $id = get_the_id();?>
                      <a data-title="Patch Desktops" href="#" id="text-field" name="<?php echo $meta_key;?>" data-type="text" data-inputclass="form-control" data-pk="<?php echo $id;?>" class="text-field">
                        <?php echo get_post_meta( $id, $meta_key, true ); $id = $meta_key = '';?>
                      </a>
                    </td>
                </tr>
            ...
            <table class="table table-striped">
              <tbody>
                ...
                <tr>
                  ...
                  <th scope="row"><strong>Sources:</strong></th>
                  <td>
                    <?php $meta_key = 'backup_source'; $id = get_the_id(); ?>
                    <a data-title="Backup Sources" href="#" id="backup_source" name="<?php echo $meta_key;?>" data-type="checklist" data-value="" data-source="[{value:'vmware' ,text:'VMware'},{value:'system_state',text:'System State'},{value:'ms_sql',text:'MS SQl'},{value:'network_shares',text:'Network Shares'},{value:'hyper_v',text:'Hyper V'}]"
...
<div id="logins" class="tab-pane fade">
          <ul class="nav nav-tabs" style="background-color:#3873b9;margin-top:-20px;">
            <li class="active"><a href="#logins_local" role="tab" data-toggle="tab">Local Credentials</a></li>
            <li><a href="#logins_teamviewer" role="tab" data-toggle="tab">Teamviewer Credentials</a></li>
            <li><a href="#logins_ex05" role="tab" data-toggle="tab">Ex05</a></li>
												 <li><a href="#logins_vpn" role="tab" data-toggle="tab">VPN</a></li>
         </ul>
    <!--Logins tab content-->
    <div class="tab-content">
