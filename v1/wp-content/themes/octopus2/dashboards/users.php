...
if ($the_query->have_posts()) : ?>
            ...
            <div class="table-responsive">
              <table class="table">
                <tr>
                  <th><p class="text-danger"><i class="fa fa-user-plus" title="Number of users"></i> <?php echo $the_query->found_posts; ?> Users</p></th>
                ...
                <td align="center">    <a href="<?php the_permalink();?>" target="_blank"><span class="fas fa-eye fa-lg" title="Fullview"></span></a></td>
                  ...
                  <td align="center"><a href="#userstatus_<?php $post_id = get_the_ID(); echo $post_id;?>" data-toggle="modal" data-target="#userstatus_<?php $post_id = get_the_ID(); echo $post_id;?>"> <span class="fa fa-check-circle fa-lg <?php if( empty( get_post_meta( $post_id, 'user_status', true ) ) ) : echo 'false'; endif; ?>" style="color:#50AE54" title="User Status"></span></a>
                     <a href="#employmenttype_<?php $post_id = get_the_ID(); echo $post_id;?>" data-toggle="modal" data-target="#employmenttype_<?php $post_id = get_the_ID(); echo $post_id;?>"><span class="fas fa-user-tie fa-lg <?php if( empty( get_post_meta( $id, 'employment_status', true ) ) ) : echo 'false'; endif; ?>" title="Employment Type" ></span></a>
                     <a href="#userlogins_<?php $post_id = get_the_ID(); echo $post_id;?>" data-toggle="modal" data-target="#userlogins_<?php $post_id = get_the_ID(); echo $post_id;?>"><span class="fas fa-sign-in-alt fa-lg <?php if( empty( get_post_meta( $id, 'Config', true ) ) ) : echo 'false'; endif; ?>" title="User Logins"></span></a>
                     <a href="#emailconfig_<?php $post_id = get_the_ID(); echo $post_id;?>" data-toggle="modal" data-target="#emailconfig_<?php $post_id = get_the_ID(); echo $post_id;?>"><span class="fas fa-envelope fa-lg <?php if( empty( get_post_meta( $id, 'Config', true ) ) ) : echo 'false'; endif; ?>" title="Email Configuration"></span></a>
                     <a href="#vpnaccess_<?php $post_id = get_the_ID(); echo $post_id;?>" data-toggle="modal" data-target="#vpnaccess_<?php $post_id = get_the_ID(); echo $post_id;?>"> <span class="fas fa-building fa-lg <?php if( empty( get_post_meta( $id, 'vpn_access', true ) ) ) : echo 'false'; endif; ?>" title="VPN Access"></span></a>
