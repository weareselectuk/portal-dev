...
<!--General tab content-->
     <div class="tab-content">
        <div id="overview_1" class="tab-pane fade active in">
        ...
        <div id="purchasing_2" class="tab-pane fade">
           <div class="table-responsive">
          															<table class="table table-striped">
                      <tbody>
																	  	  <tr>
...
<!--Logins tab content-->
        ...
        <div id="logins" class="tab-pane fade ">
					  <ul class="nav nav-tabs">
								<li class="active"><a href="#local" data-toggle="tab">local</a>
								</li>
								<li><a href="#logins_teamviewer" data-toggle="tab">teamviewer</a>
								</li>
								</ul>
								<div class="tab-content">
