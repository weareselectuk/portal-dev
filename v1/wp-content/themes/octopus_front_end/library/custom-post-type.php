...
function cpt_migrations() { 
	...
	register_post_type( 'migrations', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			...
			'menu_icon' => 'https://dev.weareselect.uk/wp-content/themes/honeypot/fonts/fontawesome-free-5.0.9/advanced-options/raw-svg/solid/rocket.png', /* the icon for the custom post type menu  https://developer.wordpress.org/resource/dashicons/ */
			'rewrite' => true,
			'capability_type' => 'post',
			'hierarchical' => false,
			/* the next one is important, it tells what's enabled in the post editor */
