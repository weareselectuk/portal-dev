		...
		<div class="col-md-12">
			<div class="panel panel-primary">
						<div class="panel-heading">
							<h5 class="panel-title">Workstation Dashboard for asset: <strong><?php echo get_post_meta( get_the_id(), 'asset_id', true );?></strong></h5>
					...
					<div class="table-responsive">
    																 <table class="table table-striped">
																		...
																		<th scope="row">TPN Chip:</th>
																	  	<td colspan="3"><?php $meta_key = 'tpn_chip'; $id = get_the_id();?><a data-title="TPN Chip" href="#" id="text-field" name="<?php echo $meta_key;?>" data-type="text" data-inputclass="form-control" data-pk="<?php echo $id;?>" class="text-field"><?php echo get_post_meta( $id, $meta_key, true ); $id = $meta_key = '';?></a></td>
																	   </tbody>
																	</table>
