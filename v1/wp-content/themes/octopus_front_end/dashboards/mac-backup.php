		...
		<div class="col-md-12">
			<div class="panel panel-primary">
						<div class="panel-heading">
							<h5 class="panel-title">Mac Dashboard for asset: <strong><?php echo get_post_meta( get_the_id(), 'asset_id', true );?></strong></h5>
					...
					<div class="table-responsive">
																	 ...
																	 <tbody>
																	    ...
																	    <th scope="row">Serial Number:</th>
																	      <td><?php $meta_key = 'serial_number'; $id = get_the_id();?><a data-title="Serial Number" href="#" id="text-field" name="<?php echo $meta_key;?>" data-type="text" data-inputclass="form-control" data-pk="<?php echo $id;?>" class="text-field"><?php echo get_post_meta( $id, $meta_key, true ); $id = $meta_key = '';?></a></td>
																		</tr>
