            ...
            <table class="table table-striped">
              <tbody>
                <tr>
                  ...
                  <th scope="row"><strong>AV Profile - Desktops & Laptops:</strong></th>
                  <td>
                    <?php $meta_key = 'AV_Profile_Desktops_Laptops'; $id = get_the_id();?>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    ...
                    <a data-title="AV Profile - Servers" href="#" id="text-field" name="<?php echo $meta_key;?>" data-type="text" data-inputclass="form-control" data-pk="<?php echo $id;?>" class="text-field">
                      <?php echo get_post_meta( $id, $meta_key, true ); $id = $meta_key = '';?>
                    </a>
                  </td>
            ...
            <table class="table table-striped">
              <tbody>
                <tr>
                  ...
                  <th scope="row"><strong>Patch Laptops:</strong></th>
                  <td>
                    <?php $meta_key = 'patch_profile_Laptops'; $id = get_the_id();?>
                    <a data-title="Patch Laptops" href="#" id="text-field" name="<?php echo $meta_key;?>" data-type="text" data-inputclass="form-control" data-pk="<?php echo $id;?>" class="text-field">
                      <?php echo get_post_meta( $id, $meta_key, true ); $id = $meta_key = '';?>
                    </a>
                  </td>
                </tr>
            ...
            <table class="table table-striped">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <?php $meta_key = 'local_password'; $id = get_the_id();?>
                    <a data-title="Screensaver Password" href="#" id="text-field" name="<?php echo $meta_key;?>" data-type="text" data-inputclass="form-control" data-pk="<?php echo $id;?>" class="text-field">
                      <?php echo get_post_meta( $id, $meta_key, true ); $id = $meta_key = '';?>
                    </a>
                  </td>
                </tr>
