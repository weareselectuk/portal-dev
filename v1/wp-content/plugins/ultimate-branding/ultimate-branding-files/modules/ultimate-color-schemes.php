			...
			$colors = array(
				...
				'Forms' => array(
					'ucs_checkbox_radio_color' => array(
						'title' => __( 'Checkbox / Radio Button', 'ub' ),
						'default' => '#45b29d',
				...
				'Core UI' => array(
					'ucs_primary_button_background_color' => array(
						'title' => __( 'Primary Button Background', 'ub' ),
						'default' => '#334d5c',
						'value' => ub_get_option( 'ucs_primary_button_background_color', '#334d5c' ),
					),
					'ucs_primary_button_text_color' => array(
						'title' => __( 'Primary Button Text', 'ub' ),
						'default' => '#fff',
						'value' => ub_get_option( 'ucs_primary_button_text_color', '#fff' ),
					),
					'ucs_primary_button_text_color_shadow' => array(
						'title' => __( 'Primary Button Text Shadow', 'ub' ),
						'default' => '#334d5c',
						'value' => ub_get_option( 'ucs_primary_button_text_color_shadow', '#334d5c' ),
					),
					'ucs_primary_button_text_color_shadow_hover' => array(
						'title' => __( 'Primary Button Text Shadow Hover', 'ub' ),
						'default' => '#ec4',
						'value' => ub_get_option( 'ucs_primary_button_text_color_shadow_hover', '#ec4' ),
					),
					'ucs_primary_button_hover_background_color' => array(
						'title' => __( 'Primary Button Hover Background', 'ub' ),
						'default' => '#EFC94C',
						'value' => ub_get_option( 'ucs_primary_button_hover_background_color', '#EFC94C' ),
					),
					'ucs_primary_button_hover_text_color' => array(
						'title' => __( 'Primary Button Hover Text', 'ub' ),
						'default' => '#fff',
						'value' => ub_get_option( 'ucs_primary_button_hover_text_color', '#fff' ),
					),
					'ucs_disabled_button_background_color' => array(
						'title' => __( 'Disabled Button Background', 'ub' ),
						'default' => '#cccccc',
						'value' => ub_get_option( 'ucs_disabled_button_background_color', '#cccccc' ),
					),
					'ucs_disabled_button_text_color' => array(
						'title' => __( 'Disabled Button Text', 'ub' ),
						'default' => '#000',
				...
				'Themes' => array(
					...
					'ucs_admin_active_theme_details_background_color' => array(
						'title' => __( 'Active Theme Details Background', 'ub' ),
						'default' => '#45b29d',
				...
				'Plugins' => array(
					'ucs_admin_active_plugin_border_color' => array(
						'title' => __( 'Active Plugin Border', 'ub' ),
						'default' => '#efc94c',
