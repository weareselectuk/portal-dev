...
<form action="" onsubmit="return validate_wpsp_admin_popup_form(this);">
    ...
    <div class="wpsp_popup_form_element">
        ...
        <input class="wpsp_fullwidth" type="text" name="status_name" value=""/>
    </div>
    ...
    <?php do_action('wpsp_get_add_status');?>
    
    <input type="hidden" name="action" value="wpsp_set_add_status" />
...
function validate_wpsp_admin_popup_form(obj){
    ...
    <?php do_action('validate_wpsp_get_add_status');?>
