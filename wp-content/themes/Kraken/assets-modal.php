...
-->
<!-- Asset Status -->
<div class="modal fade bd-example-modal-lg" id="assetstatus_<?php $post_id = get_the_ID();    echo $post_id;?>"
                ...
                <tr>
                  ...
                  <td colspan="3">
                    <?php $meta_key = 'asset_status'; $id = get_the_id(); ?><a data-title="Asset Status" href="#" id="asset-status"
                      name="<?php echo $meta_key;?>" data-type="select" data-value="" data-source="[{value:'Active',text:'Active'},{value:'Not Active',text:'Not Active'}]"
...
<div class="modal fade" id="assetprolicense_<?php $post_id = get_the_ID();
...
<!-- Asset Backup -->
<div class="modal fade bd-example-modal-lg" id="assetbackup_<?php $post_id = get_the_ID();
   echo $post_id;?>"
  tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
...
<!-- Patch Management -->
<div class="modal fade" id="assetpatchmanagement_<?php $post_id = get_the_ID();    echo $post_id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
  aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
...
<div class="modal fade bd-example-modal-lg" id="assetlogins_<?php $post_id = get_the_ID();    echo $post_id;?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
...
<div class="modal fade bd-example-modal-lg" id="assetex05_<?php $post_id = get_the_ID();    echo $post_id;?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
...
<div class="modal fade bd-example-modal-lg" id="assetsecurity_<?php $post_id = get_the_ID();    echo $post_id;?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
...
<div class="modal fade bd-example-modal-lg" id="assetspecs_<?php $post_id = get_the_ID();    echo $post_id;?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg">
...
<div class="modal fade bd-example-modal-lg" id="assetwarranty_<?php $post_id = get_the_ID();    echo $post_id;?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg">
...
<!-- Asset Tickets -->
<div class="modal fade bd-example-modal-lg" id="assettickets_<?php $post_id = get_the_ID();    echo $post_id;?>"
  tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
...
<!-- Asset Diary -->
<div class="modal fade bd-example-modal-lg" id="supportdiary_<?php $post_id = get_the_ID();    echo $post_id;?>"
  tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
