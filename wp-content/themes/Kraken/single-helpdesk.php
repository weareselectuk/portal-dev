...
?>
            ...
            <li class="right-links" style="float:right">
          <td align="right"><a href="#cb1" data-toggle="modal" data-target="#cb1" style="background-color:#EEEDED !important;border-right: 8px solid white;"> <span class="fa fa-building" title="Key Client"></span></a>
 <a href="#domain_tcpip" data-toggle="modal" data-target="#cb2" style="background-color:#EEEDED !important;border-right: 8px solid white;"><span class="fa fa-sitemap" title="Domain TCPIP"></span></a>
 <a href="#email_setup" data-toggle="modal" data-target="#cb3"  style="background-color:#EEEDED !important;border-right: 46px solid white;"><span class="fas fa-envelope" title="Email Setup"></span></a> 
 </td>
 </li>
