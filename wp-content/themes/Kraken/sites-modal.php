              ...
              <table class="table table-striped table-hover">
                <tbody>
                  <tr>
                    ...
                    <td colspan="3">
                    <?php $meta_key = 'site_status'; $id = get_the_id(); ?><a data-title="Site Status" href="#" id="site-status"
...
<div class="modal" id="sitemap_<?php $post_id = get_the_ID();
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div id="map_<?php $post_id = get_the_ID();
    echo $post_id;?>"></div>
   <? /* <script>
...
function initMap() {
  ...
  var map = new google.maps.Map(
      document.getElementById('map_<?php $post_id = get_the_ID();
   echo $post_id;?>'), {zoom: 12, center: site});
