<div class="row">
<div class="popover fade bottom 1 in" id="key_client" tabindex="-1" role="tooltip" style="float:right;width: 573px;max-width:573px; left:61.7%;color:#999;top:14%" aria-hidden="true" >
<div class="arrow" style="display:block; left:76%"></div>
  <div class="popover-content" style="width: 571px;background-color:#EEEDED">
    <div class="popover-header" style="width: 573px;margin-left: -15px;margin-bottom: 13px;padding-bottom: 15px; background-color: white;margin-top: -16px;">
      <h5 class="popover-title" id="examplepopoverLongTitle">Email Configuration</h5>
    </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a data-title="Client Status" href="#" id="client-status" name="<?php echo $meta_key;?>" data-type="select" data-value="" data-source="[{value:'Active',text:'Active'},{value:'Not Active',text:'Not Active'},{value:'',text:'Empty'}]"
...
<div class="popover fade bottom 2 in" id="domain_tcpip" tabindex="-1" role="tooltip" style="width: 573px;max-width:573px; left:64.5%;color:#999; top:14%">
<div class="arrow" style="display:block; left:76%"></div>
<div class="popover-content" style="width: 571px;background-color:#EEEDED">
    <div class="popover-header" style="width: 573px;margin-left: -15px;margin-bottom: 13px;padding-bottom: 15px; background-color: white;margin-top: -16px;">
    <h5 class="panel-title">Networking Configuration</h5>
...
<div class="popover fade bottom 3 in" id="email_setup" role="tooltip" style="width: 573px;max-width:573px; left:64%;color:#999; top:14%">
  <div class="arrow" style="display:block; left:76%"></div>
  <div class="popover-content" style="width: 571px;background-color:#EEEDED">
    <div class="popover-header" style="width: 573px;margin-left: -15px;margin-bottom: 13px;padding-bottom: 15px; background-color: white;margin-top: -16px;">
      <h5 class="popover-title" id="examplepopoverLongTitle">Email Configuration</h5>
    ...
    <div class="table-responsive">
      <table class="table table-striped">
        ...
        <tbody>
        <tr>
            <th scope="row"><strong>Email Provide 2:</strong></th>
            <td>
              <?php $meta_key = 'email_provider'; $id = get_the_id(); ?>
              <a data-title="Email Provider" href="#" id="vpn" name="<?php echo $meta_key;?>" data-type="select" data-value="" data-source="[{value:'Gsuite',text:'GSuite'},{value:'Office 365',text:'Office 365'},{value:'Empty',text:'Empty'}]" data-pk="<?php echo $id;?>"
                class="text-field">
                <?php echo get_post_meta( $id, $meta_key, true ); $id = $meta_key = '';?>
              </a>
            </td>
...
<div class="arrow" style="display:block; left:76%"></div>
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            <th scope="row"><strong>Email Setup Guide:</strong></th>
            <td>
              <?php $meta_key = 'email_setup_guide'; $id = get_the_id(); ?>
              <a data-title="Email Setup Guide" href="#" id="text-field" name="<?php echo $meta_key;?>" data-type="text" data-inputclass="form-control" data-pk="<?php echo $id;?>" class="text-field">
                <?php echo get_post_meta( $id, $meta_key, true ); $id = $meta_key = '';?>
              </a>
            </td>
          </tr>
          ...
          <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal fade" id="userm" tabindex="-1" role="dialog" aria-labelledby="email" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="usermo">Create User</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
                          </div>
...
<div class="modal fade" id="sitem" tabindex="-1" role="dialog" aria-labelledby="email" aria-hidden="true">
          ...
          <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal fade" id="externalservicesm" tabindex="-1" role="dialog" aria-labelledby="email" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="externalm">Create External Service</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
                          </div>
